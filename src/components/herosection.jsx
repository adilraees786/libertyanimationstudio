    ...
    <section id="home" className="hero-section">
      <div className="container mx-auto py-20 md:py-30 relative z-10">
        ...
        <h1 className="flex flex-col  leading-tight mb-6">
          <span className="text-[var(--text-color)] text-[30px] md:text-[60px] font-black tracking-[4px] uppercase drop-shadow-2xl">
            STOP EDITING
          </span>
          <span className="text-[var(--primary-text-color)] text-[30px] md:text-[60px] font-black tracking-[4px] uppercase">
            START GROWING
          </span>
        </h1>
